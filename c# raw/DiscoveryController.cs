...
static class DiscoveryController
{
	...
	public static void DrawDiscovery()
	{
		...
		if ((SwinGame.KeyDown(KeyCode.VK_LSHIFT) | SwinGame.KeyDown(KeyCode.VK_RSHIFT)) & SwinGame.KeyDown(KeyCode.VK_C)) {
			DrawField(GameController.HumanPlayer.EnemyGrid, GameController.ComputerPlayer, true);
		} else {
			DrawField(GameController.HumanPlayer.EnemyGrid, GameController.ComputerPlayer, false);
		}
